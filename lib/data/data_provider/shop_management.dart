...
class ShopManagementFunctions {
  ...
  updatingShopImage(BuildContext context) async {
    if (BlocProvider.of<ProfileShopImageBloc>(context, listen: false)
        ...
        .newShopImagePath
        .isNotEmpty) {
      final collection = CollectionReferences().shopDetailsReference();
      ...
      try {
        final shopImageref = firebase_storage.FirebaseStorage.instance
            ...
            .child(BlocProvider.of<ProfileShopImageBloc>(context, listen: false)
                .state
                .newShopImagePath);
        await shopImageref.putData(
            BlocProvider.of<ProfileShopImageBloc>(context, listen: false)
                .state
        ...
        await collection
            .doc(data.id)
            .update({SalonDocumentModel.shopImage: url});
      } catch (e) {
